...
const overlaySvg = `<svg width="${WIDTH}" height="${HEIGHT}" viewBox="0 0 ${WIDTH} ${HEIGHT}" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="82" y="326" font-family="Helvetica, Arial, sans-serif" font-size="30" font-weight="400" fill="#57534E">Five strategists. One orchestrator.</text>
  <line x1="82" y1="358" x2="234" y2="358" stroke="#B45309" stroke-width="4" stroke-linecap="round"/>
  <text x="82" y="410" font-family="Helvetica, Arial, sans-serif" font-size="26" font-weight="400" fill="#78716C">A five-agent, four-phase strategy</text>
